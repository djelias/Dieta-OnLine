...
public class ControladorBD extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table DIETA(ID_DIETA INTEGER PRIMARY KEY NOT NULL, NOMBRE varchar, CALORIAS_DIA integer, SEXO varchar, MERIENDAS integer, " +
        ...
        db.execSQL("create table PERFIL(ID_PERFIL INTEGER PRIMARY KEY NOT NULL, ID_USUARIO integer, ID_DIETA integer, EDAD integer, PESO_INICIO float, SEXO varchar, " +
                "ESTATURA float, ESTADO_SALUD varchar, ALERGIAS varchar, FOREIGN KEY(ID_USUARIO) REFERENCES USUARIO(ID_USUARIO))");
        ...
        db.execSQL("create table TIEMPO_COMIDA(ID_TIEMPO_COMIDA INTEGER PRIMARY KEY NOT NULL, PROTEINA varchar, CARBOHIDRATO varchar, VEGETAL varchar, FRUTA varchar, TIEMPO varchar, DIA varchar, " +
                "ID_DIETA integer, FOREIGN KEY(ID_DIETA) REFERENCES DIETA(ID_DIETA))");
        db.execSQL("create table USUARIO(ID_USUARIO INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, NOMBRE varchar, CONTRASENA varchar, EMAIL varchar, TELEFONO varchar, ROL varchar)");
